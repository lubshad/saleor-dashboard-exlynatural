...
: "${DEPLOY_PATH:?Set DEPLOY_PATH in deploy.env, for example /var/www/saleor-dashboard-exlynatural}"
...
echo "Syncing dashboard source to ${DEPLOY_TARGET}:${DEPLOY_PATH}"
...
echo "Building and restarting dashboard on server"
